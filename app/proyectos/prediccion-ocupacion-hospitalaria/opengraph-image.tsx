...
export const alt = 'Predicción de ocupación hospitalaria — Aram Zakzuk'
    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#EFE8D9', padding: '64px', fontFamily: 'serif', color: '#111110' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 20, letterSpacing: 3, textTransform: 'uppercase', opacity: 0.7 }}>
          ...
          <div style={{ display: 'flex' }}>Hospital Ops</div>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ display: 'flex', height: 6, width: 120, background: '#1F6F5C' }} />
          <div style={{ display: 'flex', fontSize: 64, lineHeight: 1.05, fontWeight: 500, letterSpacing: -1 }}>Predecir camas hospitalarias con criterio clínico-operativo</div>
          <div style={{ display: 'flex', fontSize: 26, opacity: 0.75, letterSpacing: -0.3 }}>Reducción estimada 30–40% varianza · HL7 FHIR R4</div>
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 20, opacity: 0.7, borderTop: '1px solid #111110', paddingTop: 24 }}>
          <div style={{ display: 'flex' }}>alejandrozakzuk.com/proyectos/prediccion-ocupacion-hospitalaria</div>
          <div style={{ display: 'flex' }}>Python · Time Series</div>
        </div>
      </div>
    ),
    size

  ...
  return (
    <>
          ...
          <div className="grid grid-cols-12 gap-y-10 md:gap-x-8 items-end">
            ...
            <aside className="col-span-12 md:col-span-4 lg:col-span-3 space-y-6 md:border-r md:border-hairline md:pr-8 md:self-stretch md:pb-4">
              ...
              <div className="hidden md:block pt-4">
                <div className="group relative aspect-square w-full border border-hairline bg-paper overflow-hidden">
                  <Image
            ...
            <div className="col-span-12 md:col-span-8 lg:col-span-9">
              <h1 className="display-hero word-reveal">
                ...
                <span style={{ animationDelay: '100ms' }}>Salud Digital</span>{' '}
                <span style={{ animationDelay: '200ms' }}>e</span>{' '}
                <span style={{ animationDelay: '300ms' }}>
                  <span className="hl-accent">IA en Sanidad</span>.
                </span>
                <br />
                <span style={{ animationDelay: '400ms' }}>La combinación escasa</span>{' '}
            ...
            <div className="col-span-12 pt-10 md:pt-16 rule-t grid grid-cols-12 gap-y-8 md:gap-x-8">
              <div className="col-span-12 md:col-span-7 space-y-4" data-aos="fade-up">
                ...
                <p className="caption normal-case tracking-normal leading-relaxed" style={{ fontSize: '0.95rem' }}>
                  Busco rol senior en HealthTech, MedTech, Pharma Digital, MedDevice o innovación hospitalaria. Madrid · Remoto · Híbrido.
                </p>
              </div>
              <div className="col-span-12 md:col-span-5 md:border-l md:border-hairline md:pl-8 flex flex-col gap-5 content-start">
                <div>
      ...
      <section aria-label="Prueba social verificable" className="rule-t rule-b py-5">
        <div className="container">
          <ul className="grid grid-cols-2 md:grid-cols-4 gap-y-3 md:gap-y-0 font-mono text-xs text-ink-2">
      ...
      <Section id="proyectos" index="№ 04 — Proyectos" title="Proyectos que fundamentan el criterio" subtitle="Validación técnica propia. El criterio no se improvisa: se construye con datos reales, métricas verificables y cumplimiento regulatorio desde el día uno. Código abierto, demos públicas.">
        ...
        <div className="mt-12">
          <a href="/proyectos" className="ed-link font-mono text-sm">Índice completo de proyectos →</a>
        </div>
      </Section>
        ...
        <div className="container">
          <div className="grid grid-cols-12 gap-y-12 md:gap-x-8 mb-20">
            ...
            <div className="col-span-12 md:col-span-9">
              <h2 className="display-l mb-6">Un perfil.<br /><span>Tres capas.</span></h2>
              <p className="lead">
          ...
          {publications.slice(0,3).map((p, i) => (
            <div data-aos="fade-up" data-aos-delay={100 * (i + 1)} key={p.id}>
              <Card>
                ...
                <a href={p.link} className="mt-3 inline-block ed-link font-mono text-xs">Leer →</a>
              </Card>
            </div>
          ))}
        </div>
        <div className="mt-8" data-aos="fade-in" data-aos-delay="400">
          <a href="/publicaciones" className="ed-link font-mono text-sm">Archivo completo →</a>
        </div>
      </Section>
      ...
      <Section id="blog" index="№ 06 — Blog" title="Notas editoriales" subtitle="Análisis ejecutivo y técnico sobre EHDS, EU AI Act, CDSS y transformación digital sanitaria. Publicación nueva cada lunes.">
        {(() => {
          ...
          return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-t-2 border-hairline">
          {list.map((post, i) => (
            <article
              key={post.slug}
              data-aos="fade-up"
            ...
            >
              ...
              <a href={`/blog/${post.slug}`} className="block group">
                <h3 className="display-m text-2xl leading-snug group-hover:text-accent transition-all">
                  {post.title}
                </h3>
              </a>
          ...
          <div className="grid grid-cols-12 gap-y-10 md:gap-x-8 items-end">
            ...
            <div className="col-span-12 md:col-span-9">
              <h2 className="display-xl">
                ¿Buscas este perfil para tu <span><span className="hl-accent">equipo</span></span>?<br />Hablemos.
              </h2>
              ...
              <div className="mt-10 flex flex-col gap-6">
                <div className="flex flex-wrap gap-4 items-center">
                  <a href="/cv/CV_Aram_Zakzuk.pdf" target="_blank" rel="noopener noreferrer" className="btn-ink">Descargar CV →</a>
                  <a href="/contacto" className="btn-ghost">Contactar</a>
                  <a href="/posiciones" className="ed-link font-mono text-xs">Ver roles que me interesan →</a>
                </div>
                <div>

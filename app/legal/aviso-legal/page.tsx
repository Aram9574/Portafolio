  ...
  return (
    <Section id="legal-aviso" title="Aviso legal">
      <div className="prose prose-stone max-w-none">
        <p className="text-ink-2">El contenido de esta web tiene carácter divulgativo y no constituye asesoramiento médico ni profesional.
...
Todos los derechos de autor y propiedad intelectual de los textos, diseños y contenidos corresponden a Aram Zakzuk, salvo que se indique lo contrario. Queda prohibida la reproducción total o parcial sin autorización expresa.

    ...
    return (
      <div className="absolute left-1/2 top-full z-30 w-[680px] -translate-x-1/2 pt-2">
        <div className="card p-6 grid grid-cols-2 gap-6">
          <div>
            <p className="text-ink font-medium mb-2">Perfil</p>
            <ul className="space-y-2 text-sm text-muted">
              <li><Link className="hover:text-ink" href="/sobre-mi">Perfil profesional</Link></li>
              <li><Link className="hover:text-ink" href="/habilidades">Habilidades</Link></li>
              <li><Link className="hover:text-ink" href="/experiencia">Experiencia</Link></li>
              <li><Link className="hover:text-ink" href="/educacion">Educación</Link></li>
            </ul>
          </div>
          <div>
            <p className="text-ink font-medium mb-2">Lenguas</p>
  ...
  return (
    <div className="absolute left-1/2 top-full z-30 w-[860px] -translate-x-1/2 pt-2">
      <div className="card p-6 grid grid-cols-3 gap-6">
        <div>
          <p className="text-ink font-medium mb-2">ML</p>
          <ul className="space-y-2 text-sm text-muted">
            <li><Link className="hover:text-ink" href="/proyectos/cancer-mama-ml">Cáncer de mama (clasificación)</Link></li>
            <li><Link className="hover:text-ink" href="/proyectos/riesgo-cardiovascular">Riesgo cardiovascular (Framingham)</Link></li>
          </ul>
        </div>
        <div>
